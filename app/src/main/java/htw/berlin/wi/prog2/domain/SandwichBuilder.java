...
public class SandwichBuilder {
    ...
    private void checkRules() {
        ...
        // TODO hier mit ingredient.getCategory() statt mit Menu.buns und Menu.sauces arbeiten
        if(ingredients.stream().filter((ing) -> Menu.buns.containsValue(ing)).collect(Collectors.toList()).size() > 1)
